# Atlas — Redesign-Referenzen (Canvas of Kings)

Interaktive Mockups und Vorschläge für die Annäherung des Atlas-Editors an
[Canvas of Kings](https://store.steampowered.com/app/2498570/Canvas_of_Kings/).
Alle Grafiken sind **live in Canvas 2D gerechnet** (kein Bild) — Datei lokal im
Browser öffnen und die Regler/Buttons ausprobieren.
...
> Diese HTML-Dateien sind reine Design-Referenzen (kein Produktivcode, nicht
> gebündelt). Der gewählte Malstil ist **Gouache**.
