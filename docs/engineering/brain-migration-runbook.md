...
- **C — restliche Cross-DB-Services (Zwei-Client + opake-ID-Join):**
  ...
  `admin-search-service`, `asset-link-service`, `mail-compose-service`,
  ...
  (Erledigt als Vorlage: `life-admin-links-service`, `calendar-service`,
  `backup` collect/restore [Dual-Store], `tag-service` +
  `entity-tag-search-service` + `cross-domain-search-service` [polymorphes
  Cross-Domain-Tagging].) **Muster:** Brain-Zeilen über `brainPrisma`
