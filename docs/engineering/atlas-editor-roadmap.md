...
- 🔶 **#14 Werkstatt-Layout** — Kontext-Mini-Toolbar (CoK-Ergonomie) umgesetzt: schwebt über dem einzeln selektierten Objekt/Feature mit Schnellaktionen (Duplizieren · Portal/GM-Sichtbarkeit · Löschen), folgt Pan/Zoom. *Offen: der große Chrome-Reflow (andockbarer Inspector rechts · Asset-Shelf unten) — profitiert von Owner-Design-Freigabe (Mockup: `docs/design/atlas-redesign/atlas-ui-proposals.html`).*

**Offen (Rest von #14):** großer Werkstatt-Chrome-Reflow — bewusst für
Owner-Design-Review offen gelassen (alle funktionalen Roadmap-Punkte sind
umgesetzt).
