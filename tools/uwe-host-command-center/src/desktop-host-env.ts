...
export const HOST_ENV_FIELDS: HostEnvField[] = [
  ...
  { key: "FAMILY_PORT", label: "Family-Port", group: "Ports", kind: "number" },
  ...
  { key: "NEXT_PUBLIC_FAMILY_URL", label: "Family-URL", group: "Öffentliche URLs", kind: "text", help: "Adresse, auf die jeder Family-Link zeigt (z. B. https://family.uwe.example). Leer = Loopback http://localhost:3004." },
