...
/**
 * Atlas3DDescribePanel — KI-Beschreibung für Atlas-3D-Ebenen.
 *
 * Geöffnet über "✦ Beschreiben" in der Editor-Shell. Ruft /api/brain/run mit
 * atlas_describe_region auf, zeigt das Ergebnis read-only und lässt den DM
 * kopieren oder verwerfen — nie automatisch in den Kanon übernommen.
 */
...
export interface Atlas3DDescribePanelProps {
  worldSlug: string;
  /** Titel der beschriebenen Ebene (Knoten-Titel). */
  nodeTitle: string;
  /** Ebenen-Art, z. B. "Globus" oder "Kontinent". */
  levelLabel: string;
  onClose: () => void;
}
...
export function Atlas3DDescribePanel({ worldSlug, nodeTitle, levelLabel, onClose }: Atlas3DDescribePanelProps) {
  ...
  return (
    ...
    >
      <div
        ...
        data-testid="atlas3d-describe-panel"
      >
        {/* Header */}
        <div className="flex items-center justify-between">
          <h2 className="m-0 text-lg font-semibold">Ebene beschreiben — KI-Entwurf</h2>
        ...
        <p className="m-0 text-sm text-muted-foreground">
          Ebene: <strong>{nodeTitle}</strong> ({levelLabel}) — Beschreibungsvorschlag (nie automatisch im Kanon)
        </p>
        ...
        <details className="text-xs">
          ...
          <div className="mt-2 flex flex-wrap gap-2">
            <div className="flex flex-col gap-1">
              <Label htmlFor="atlas3d-describe-provider" className="text-xs font-normal">
                Provider
              </Label>
              <select
                id="atlas3d-describe-provider"
                value={provider}
            ...
            <div className="flex flex-col gap-1">
              <Label htmlFor="atlas3d-describe-model" className="text-xs font-normal">
                Modell
              </Label>
              <Input
                id="atlas3d-describe-model"
                value={model}
        ...
        <div className="flex flex-col gap-1.5 text-sm">
          <Label htmlFor="atlas3d-describe-context">Zusätzlicher Kontext (optional)</Label>
          <Input
            id="atlas3d-describe-context"
            value={contextHint}
