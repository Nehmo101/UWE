 ...
 * Uses the existing /api/admin/mail/accounts routes.
 */
        ...
        accounts.map((account) => (
          ...
          >
            ...
            <MailButton
              variant="subtle"
              size="sm"
              onClick={() => void runAccountAction(`/api/admin/mail/accounts/${account.id}/test`, "POST")}
              disabled={busy}
            >
              Test
            </MailButton>
            <MailButton
              variant="subtle"
              size="sm"
              onClick={() => void runAccountAction("/api/admin/mail/sync", "POST", { accountId: account.id })}
              disabled={busy}
            >
              Sync
            </MailButton>
            <IconButton
              ...
              tone="danger"
              title="Konto löschen"
              onClick={() => void runAccountAction(`/api/admin/mail/accounts/${account.id}`, "DELETE")}
              disabled={busy}
            />
          </div>
        ))
