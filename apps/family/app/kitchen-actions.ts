...
function shopping() {
  return createShoppingService(familyPrisma);
}
...
// KI-Wochenvorschlag: suggestWeek/applyDraft/adoptDraft/dismissDraft leben in
// `kitchen-plan-actions.ts` — dort hängt der KI-Guard (requireFamilyAiActionAuth).
