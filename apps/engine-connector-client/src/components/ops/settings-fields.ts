...
export const SETTINGS_GROUPS: SettingsGroup[] = [
  ...
  },
  {
    id: "ai",
    title: "KI",
    description: "Jede KI-Aktion läuft über den Maschinenraum-Host. Es gibt keinen Cloud-Provider.",
    fields: [
      { group: "ai", key: "enabled", label: "KI aktiv", kind: "boolean" },
      {
        ...
        kind: "boolean",
        hint: "Erzwingt den Maschinenraum-Host für jede Anfrage.",
      },
      {
        group: "ai",
  ...
  },
  {
    id: "imageStudio",
    title: "Image Studio",
    description: "Bildgenerierung — lokal auf dem Maschinenraum-Host.",
    fields: [
