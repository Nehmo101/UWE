  ...
  return (
    <div className="connector-stack">
      <Card>
        ...
        <div className="connector-stack">
          <p className="connector-muted">
            Spotify OAuth läuft ausschließlich hier auf dem Maschinenraum-PC — der UWE-Host sieht die
      ...
      <Card>
        ...
        <div className="connector-stack">
          <p className="connector-muted">
            Wähle das Spotify-Connect-Gerät auf dem Maschinenraum-PC (z. B. die laufende Spotify-App). Spotify
          ...
          {devicesResult && devicesResult.devices.length === 0 ? (
            <div className="connector-empty-state">
              {devicesResult.connected
                ? "Keine aktiven Spotify-Connect-Geräte gefunden — Spotify-App auf dem Maschinenraum-PC starten."
