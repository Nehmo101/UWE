 ...
 * Maschinenraum host and let the user choose which ones UWE may print to. The selection is
  ...
  return (
    <div className="connector-stack">
      ...
      <Card>
        ...
        <div className="connector-stack">
          <p className="connector-muted">
            Erkennt die auf dem Maschinenraum-Host installierten Drucker (Windows-Spooler bzw. CUPS)
      ...
      <div className="connector-panel">
        ...
        <p className="connector-muted">
          ...
          <code>tools/uwe-engine-connector/.env</code> festlegen. Ist die Variable gesetzt,
