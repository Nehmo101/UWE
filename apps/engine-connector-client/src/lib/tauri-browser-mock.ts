  ...
  switch (command) {
    ...
    case "start_ollama":
      return {
        ...
        message: "Browser-Vorschau: Ollama-Start ist nur in der Tauri-App auf dem Maschinenraum-PC verfügbar.",
        triedPaths: [],
      } as T;
    case "test_runner": {
    ...
    case "test_audio": {
      ...
      return {
        ...
        message: config.audioCommand
          ? "Browser-Vorschau: Audio-Test läuft nur in der Tauri-App auf dem Maschinenraum-PC."
    ...
    case "test_image": {
      ...
      return {
        ...
        message: config.imageCommand
          ? "Browser-Vorschau: Image-Test läuft nur in der Tauri-App auf dem Maschinenraum-PC."
    ...
    case "test_print": {
      ...
      return {
        ...
        message: config.printCommand
          ? "Browser-Vorschau: Print-Test läuft nur in der Tauri-App auf dem Maschinenraum-PC."
