...
<#
.SYNOPSIS
  Bringt die UWE-Staging-Umgebung on-demand auf dem Maschinenraum-PC hoch (dev-Branch).
...
.DESCRIPTION
  ...
  Der Prod-Host wird nicht angefasst. Details: docs/engineering/staging-engine.md.
...
if (-not (Test-Path $EnvFile)) {
  throw "Test-.env fehlt: $EnvFile. Kopiere deploy/engine-staging/uwe-test.env.example dorthin und passe die Werte an."
}
