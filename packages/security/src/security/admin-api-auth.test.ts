...
describe("studio role api auth", () => {
  it("blocks player session on studio API routes", () => {
    const context: ApiAuthContext = {
      user: { id: "1", displayName: "P", email: null, isOwner: false, access: { portal: true, studio: false, brain: false, family: false }, aiAccess: false },
      apiTokenId: null,
      apiTokenScopes: null,
      authMethod: "session",
    };
  ...
  it("allows dm session on studio API routes", () => {
    const context: ApiAuthContext = {
      user: { id: "2", displayName: "DM", email: null, isOwner: false, access: { portal: true, studio: true, brain: false, family: false }, aiAccess: false },
      apiTokenId: null,
      apiTokenScopes: null,
      authMethod: "session",
    };
...
describe("admin api auth", () => {
  ...
  it("allows the owner session", () => {
    const context: ApiAuthContext = {
      user: { id: "1", displayName: "A", email: null, isOwner: true, access: { portal: true, studio: true, brain: true, family: true }, aiAccess: false },
      apiTokenId: null,
      apiTokenScopes: null,
      authMethod: "session",
    };
