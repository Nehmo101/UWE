...
import { INK_ASSET_BUILDERS_BATCH4 } from "./assets-ink-batch4";
import { INK_ASSET_BUILDERS_BATCH4B } from "./assets-ink-batch4b";
...
export const INK_ASSET_LABELS: Record<InkAssetKind, string> = {
  ...
  farn: "Farngruppe",
  schilf: "Schilf",
  bluetenbaum: "Blütenbaum",
  felsnadel: "Felsnadel",
  bogenfels: "Bogenfels",
  geysir: "Geysir",
  kaktus: "Kaktus",
  duenengras: "Dünengras",
  leuchtpilz: "Leuchtpilz",
  taverne: "Taverne",
  schmiede: "Schmiede",
  scheune: "Scheune",
  windrad: "Windrad",
  ...
  stall: "Stall",
  torbogen: "Torbogen",
  wassermuehle: "Wassermühle",
  lagerfeuer: "Lagerfeuer",
  karren: "Karren",
  zeltlager: "Zeltlager",
  bienenstoecke: "Bienenstöcke",
  weltenschildkroete: "Weltenschildkröte",
  drachenschaedel: "Drachenschädel",
  schwebestein: "Schwebestein",
  riesenschwert: "Riesenschwert",
  steinkreis: "Steinkreis",
  weltenauge: "Weltenauge",
  himmelsleiter: "Himmelsleiter",
  titanenhand: "Titanenhand",
  kristallportal: "Kristallportal",
  grabmal: "Grabmal",
  wurzelthron: "Wurzelthron",
  ...
  sturmwolke: "Sturmwolke",
  kometenstein: "Kometenstein",
};
...
export const INK_ASSET_GROUPS: InkAssetGroup[] = [
  {
    ...
    label: "Natur",
    kinds: [
      "tree", "eiche", "weide", "birke", "windbaum", "bluetenbaum", "tanne", "palme", "busch", "farn", "schilf",
      "duenengras", "kaktus", "fels", "felsnadel", "bogenfels", "geysir", "pilzhain", "leuchtpilz", "kristalle", "toterbaum",
    ],
  },
  {
    key: "siedlung",
    label: "Siedlung",
    kinds: [
      "house", "taverne", "schmiede", "scheune", "stall", "speicher", "huette", "zelt", "zeltlager", "tower", "holzturm",
      "leuchtturm", "kapelle", "torbogen", "brunnen", "bruecke", "muehle", "windrad", "wassermuehle", "hafen",
      "marktstand", "lagerfeuer", "karren", "bienenstoecke", "ruine",
    ],
  },
  {
    key: "weltenbau",
    label: "Weltenbau",
    kinds: [
      "worldroot", "weltenschildkroete", "portal", "kristallportal", "obelisk", "statue", "runenstein", "schrein",
      "steinkreis", "drachenschaedel", "schwebestein", "riesenschwert", "weltenauge", "himmelsleiter", "titanenhand",
      "grabmal", "wurzelthron",
    ],
  },
  {
    key: "himmel",
    label: "Himmel",
    kinds: ["asteroid", "mond", "kometenstein", "wolkeninsel", "luftschiff", "ballon", "sturmwolke", "sternwarte"],
  },
  {
    key: "gewaesser",
    label: "Gewässer",
    kinds: ["boot", "segelschiff", "floss", "wrack", "fischerhuette", "wasserfall", "eisberg", "korallen", "seerosen"],
  },
];

/** Kinds that live on an orbit around the globe — only placeable in globe mode. */
export const GLOBE_ONLY_ASSET_KINDS: readonly InkAssetKind[] = ["asteroid", "mond", "kometenstein"];
...
const BUILDERS: Record<InkAssetKind, (tint: InkTint) => InkAssetData> = {
  ...
  ...INK_ASSET_BUILDERS_BATCH4,
  ...INK_ASSET_BUILDERS_BATCH4B,
};
...
export const INK_ASSET_DEFAULT_TINT: Record<InkAssetKind, InkTint> = {
  ...
  zeltlager: "terra",
  bienenstoecke: "paper",
  weltenschildkroete: "sepia",
  drachenschaedel: "paper",
  schwebestein: "sepia",
  riesenschwert: "paper",
  steinkreis: "sepia",
  weltenauge: "blue",
