...
export interface EngineCaptureProposalInput {
  title: string;
  content: string;
  captureType: string;
  url?: string | null;
...
export function buildEngineCaptureProposalPrompt(input: EngineCaptureProposalInput): string {
  return [
...
export function parseEngineCaptureProposalResponse(
  raw: string,
